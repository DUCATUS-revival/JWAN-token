...
module.exports = {
    ...
    networks: {
        ...
        ducxMainnet: {
            provider: () => new HDWalletProvider(MNEMONIC, 'https://ducx-mainnet-api1-https.rocknblock.io/'),
            network_id: 26483,
            gasPrice: web3.utils.toWei(DEPLOY_GAS_PRICE, 'gwei'),
            gas: DEPLOY_GAS_LIMIT,
            confirmations: 2,
            timeoutBlocks: 200,
            skipDryRun: false,
            etworkCheckTimeout: 999999
        },
        ducxTestnet: {
            provider: () => new HDWalletProvider(MNEMONIC, 'https://ducx-testnet-api1-https.rocknblock.io/'),
            network_id: 26482,
            gasPrice: web3.utils.toWei(DEPLOY_GAS_PRICE, 'gwei'),
            gas: DEPLOY_GAS_LIMIT,
            confirmations: 2,
